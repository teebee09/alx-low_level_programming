 ...
 * @valist: a list of argument pointing to char
 */
...
/**
 * print_int - print int
 * @valist: a list of argument pointing to  int
 */
 ...
 * @valist: a list of argument pointing to float no
 */
 ...
 * @valist: a list of argument pointing to a string
 */
 ...
 * @format: an array of char determining which datatype to print
 * Return: return void
 */
